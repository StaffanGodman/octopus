<template>
  <div class="container-fluid color-background p-3 mb-5 mb-md-0">
    <h1 class=" color-primary-1  text-center ">Om oss</h1>
    <div class="container-fluid color3-background rounded p-3">
      Vi är en grupp blivande JAVA-programmerare och UX-designers som har utforskat vad man kan göra med Sveriges Radios
